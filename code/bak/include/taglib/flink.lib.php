...
function lib_flink(&$ctag,&$refObj)
{
    ...
    while($dbrow=$dsql->GetObject())
    {
        ...
        {
            $link = "<a href='".$dbrow->url."' class='btn' target='_blank'>".cn_substr($dbrow->webname,$titlelen)."<span class='line_t'></span><span class='line_r'></span><span class='line_b'></span><span class='line_l'></span></a> ";
        }
        else if($type=='image')
        {
